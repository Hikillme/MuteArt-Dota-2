...
`)
	...
	typeText("> initializing core...", 18*time.Millisecond)
	time.Sleep(250 * time.Millisecond)
	fmt.Println("[ OK ] Core")

	typeText("> loading keyboard hook...", 18*time.Millisecond)
	time.Sleep(250 * time.Millisecond)
	fmt.Println("[ OK ] Keyboard Hook")

	typeText("> loading font engine...", 18*time.Millisecond)
	time.Sleep(250 * time.Millisecond)
	fmt.Println("[ OK ] Font Engine")

	typeText("> loading drawing engine...", 18*time.Millisecond)
	time.Sleep(250 * time.Millisecond)
	fmt.Println("[ OK ] Drawing Engine")

	typeText("> scanning minimap module...", 18*time.Millisecond)
	time.Sleep(250 * time.Millisecond)
	fmt.Println("[ OK ] Map Detector")
